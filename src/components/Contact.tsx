  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-zinc-950 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] rounded-full bg-brand-900/10 blur-3xl"></div>
        <div className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] rounded-full bg-brand-900/10 blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <span className="text-brand-500 font-semibold tracking-wider uppercase text-sm mb-4 block">Get in Touch</span>
            <h2 className="text-4xl md:text-6xl font-serif text-white mb-6 leading-tight">
              Ready for your yard's <span className="italic text-brand-400">fresh start?</span>
            </h2>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                <div className="w-14 h-14 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center shrink-0 group-hover:border-brand-500/50 group-hover:bg-brand-950/30 transition-colors duration-300">
                ...
                <div>
                  ...
                  <a href="tel:2156511329" className="text-2xl font-serif text-white hover:text-brand-400 transition-colors">215-651-1329</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <a href="mailto:FreshStartLandscapingCo@gmail.com" className="text-lg text-white hover:text-brand-400 transition-colors break-all">FreshStartLandscapingCo@gmail.com</a>
                </div>
              </div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-brand-500/5 to-transparent rounded-[2rem] pointer-events-none"></div>
            ...
            <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <select
                  id="service"
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all appearance-none"
                >
              ...
              <div>
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-400 hover:to-brand-500 text-white font-medium py-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-lg shadow-lg shadow-brand-900/20"
              >
